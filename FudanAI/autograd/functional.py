...
def sum(t: Tensor, axis: Union[int, Tuple[int]] = None) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=sum_bw)
    else:
...
def mean(t: Tensor, axis: Union[int, Tuple[int]] = None) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=mean_bw)
    else:
        return Tensor(data=data)
...
def neg(t: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=neg_bw)
    else:
        return Tensor(data=data)
...
def t(t: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=t_bw)
    else:
        return Tensor(data=data)
...
def relu(t: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=relu_bw)
    else:
        return Tensor(data=data)
...
def exp(t: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=exp_bw)
    else:
        return Tensor(data=data)
...
def add(t1: Tensor, t2: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=add_bw)
    else:
        return Tensor(data=data)
...
def sub(t1: Tensor, t2: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=sub_bw)
    else:
        return Tensor(data=data)
...
def mul(t1: Tensor, t2: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=mul_bw)
    else:
        return Tensor(data=data)
...
def div(t1: Tensor, t2: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        return Tensor(data=data, requires_grad=True, grad_fn=div_bw)
    else:
        return Tensor(data=data)
...
def matmul(t1: Tensor, t2: Tensor) -> Tensor:
    ...
    if requires_grad:
        ...
        if t2.requires_grad:
            matmul_bw.t1 = t1
        return Tensor(data=data, requires_grad=True, grad_fn=matmul_bw)
    else:
        return Tensor(data=data)
...
def pow(t1: Tensor, t2: float) -> Tensor:
    ...
    if requires_grad:
        ...
        pow_bw.t2 = t2
        return Tensor(data=data, requires_grad=True, grad_fn=pow_bw)
    else:
        return Tensor(data=data)
